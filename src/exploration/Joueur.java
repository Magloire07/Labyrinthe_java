...
public class Joueur
{
    ...
    // on n'implémentera pas cette méthode en considérant comme la pierre que c'est aux case d'effectué le deplacement de d'affecter la position au joueur 
    ...
    // pareil on considère que c'est la case que lance la pierre à son voisine , sachant la position de départ de la piere est celle du joueur 
